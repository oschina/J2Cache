 ...
 * @date 16/11/25 10:41
 */
public class JedisClusterTemplate extends AbstractJedisTemplate<JedisCluster, JedisClusterPoolFactory> {

    public JedisClusterTemplate() {
    }

    public JedisClusterTemplate(JedisClusterPoolFactory jedisClusterPoolFactory) {
    ...
    public long del(String key) {
        if (key.contains("*")) { // 判断key 是否包含模糊匹配
            throw new UnsupportedOperationException("redis cluster not support multi delete keys");
        } else {
