 ...
 * @date 16/11/25 10:41
 */
public class JedisSingleTemplate extends AbstractJedisTemplate<Jedis, JedisSinglePoolFactory> {

    public JedisSingleTemplate() {
    }

    public JedisSingleTemplate(JedisSinglePoolFactory jedisSinglePoolFactory) {
