...
public class J2CacheRegionFactoryTest {
    ...
    private final static Log LOG = LogFactory.getLog(J2CacheRegionFactoryTest.class);
    ...
    public void tearDown() throws Exception {
        for (Article art : this.articleService.find(Restrictions.like("title", "测试缓存", MatchMode.START))) {
