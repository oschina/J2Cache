...
import net.oschina.j2cache.hibernate5.service.IArticleService;
...
import net.oschina.j2cache.hibernate5.service.ArticleService;
...
public class J2CacheRegionFactoryTest {
    ...
    public void findUnique() {
        ...
        Map<String, Object> narticle =
                getCacheValue("net.oschina.j2cache.hibernate5.bean.Article", article.getId());
        ...
        // 缓存数据会删除
        narticle = getCacheValue("net.oschina.j2cache.hibernate5.bean.Article", article.getId());
