...
abstract class AbstractReadWriteJ2CacheAccessStrategy<T extends J2CacheTransactionalDataRegion> extends AbstractJ2CacheAccessStrategy<T> {
    ...
    @Override
    public final boolean putFromLoad(SharedSessionContractImplementor session, Object key, Object value, long txTimestamp, Object version, boolean minimalPutOverride) throws CacheException {
